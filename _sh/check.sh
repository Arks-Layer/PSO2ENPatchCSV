...
rsync --recursive --executability --whole-file . /tmp/PSO2ENPatchCSV.check/WC --exclude ".git" --del && cd /tmp/PSO2ENPatchCSV.check/WC/Files && find .. -name "*.csv" -not -path "*/.git/*" -print0|../../WC/_tools/mp.sh -0 ln -s {} . \; &
